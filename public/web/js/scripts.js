...
function initCitybook() {
 ...
 initAutocomplete();
    ...
    $(".header-user-name").on("click", function () {
        $(".header-user-menu .ul_ss").toggleClass("hu-menu-vis");
        $(this).toggleClass("hu-menu-visdec");
    });

    //    $(".header-user-name_ss").on("click", function () {
    //     $(".header-user-menu_ss ul").toggleClass("hu-menu-vis_ss");
    //     $(this).toggleClass("hu-menu-visdec-1_ss");
    // });
...
// notification toggle code
          ...
          $(document).ready(function(){
            ...
            $('.hello_asiali').click(function(e){
              e.preventDefault();
              e.stopPropagation();
              $('.notification_toggle').fadeToggle();
            });
          });
            
          $(document).click(function(){
            $('.notification_toggle').hide(); 
          });

          /*-- Press Esc To c lose div ---*/

        $(document).on( 'click', function (e) {
            if ( $( e.target ).closest('.notification_toggle').length === 0 ) {
                $('.notification_toggle').slideUp();  /*--- Content div id and class you want to be hide---*/
            }
        });
