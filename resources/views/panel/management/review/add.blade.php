...
<div class="content-body">
    <section id="configuration">
        <form class="form" id="submit_teacher_review">
            <div class="row">
                    ...
                    <div class="card" style="min-height: 490px;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="" class="form-control" placeholder="Location" name="location" required>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="projectinput1">Review</label>
                                                    <textarea class="form-control" style="width:100%;" rows="8" id="review" name="review" placeholder="Review" required></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                        ...
                        <div class="col-xl-1 col-md-1 col-12">
                            <h3 style="text-align:right;">
                                <button type="submit" class="btn btn-primary" id="save-teacher-review-processing">
                                    Submit
                                </button>
                            </h3>
                        </div>
